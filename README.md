...
Independent lab reproduction (Ubuntu 24.04, July 2026): both drivers green, `observability_score: 0`, ~6 s wall clock. Paper-grade work cites **`v1.0.0`** (historical freeze tags `paper-manifest-*` remain aliases).
...
Evidence pin: **`v1.0.0`**. Locked run-trees: GitHub Release (see disclosure note).
